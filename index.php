...
{
    print $render->osn_rendering();
}
else
{
    if(!isset($_POST['ToSigninButton']))
    {
        print $render->avtoriz();
    }
    else 
    {
...
class rendering
{
    ...
    public function osn_rendering()
    {
        $html = $this->header_output();
        $html .= $this->logo_output();
        $html .= $this->letter_output();
        $html .= $this->contacts_output();
    ...
    public function letter_output()
    {
        $html = "<form method=\"post\">
            ...
            for($i = 0; $i < 54; $i++)
            {   
                if ($_SESSION['letter'] === $this->__letterArr[$i])
                {
    ...
    public function contacts_output()
    {
        $html = "";
        
        if(isset($_SESSION['contactLetterArr']))
        {
            $html = "<div class=\"main\">
                    <div class=\"row\">";
            foreach ($_SESSION['contactLetterArr'] as $key=>$contact)
            {
        ...
        for($i=1; $i<5; $i++)
        {
            ...
            $html .="                                               <input name=\"corectnumberDop\" type=\"tel\" class=\"form-control\" id=\"phone\">                                           
                                ...
                                <li class=\"edit nav-item\">
                                <form method=\"post\">
                                    <button type=\"submit\" name=\"deletContact\" value=\"".$contact['id']."\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\"
    ...
    public function addContacts_output()
    {
        ...
        return " <div class=\"col-md-3\">
                <button type=\"button\" class=\"add btn btn-light\" data-bs-toggle=\"modal\" data-bs-target=\"#exampleModal\">
